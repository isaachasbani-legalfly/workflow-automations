...
- `keywords` is an array in the Amplemarket response; joined to a comma-separated string
- LinkedIn `industry` is treated as a **hint** only — cross-check against overview and keywords before trusting it (see Rule 9)
